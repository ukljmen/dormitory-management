...
namespace DormAPI.Migrations
{
    ...
    [Migration("20240528075217_AddStateToProblem")]
    partial class AddStateToProblem
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("DormAPI.Models.Entities.Role", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            ConcurrencyStamp = "9ffd7bf4-a433-4872-89e2-629540c33ea1",
                            Name = "Admin",
                        ...
                        {
                            Id = 2,
                            ConcurrencyStamp = "ef8e0f70-a3ab-47b9-9e81-5c96f84fe99f",
                            Name = "Manager",
                        ...
                        {
                            Id = 3,
                            ConcurrencyStamp = "dabb5445-1332-4cb8-a166-2f9e91a8691f",
                            Name = "Conservator",
                        ...
                        {
                            Id = 4,
                            ConcurrencyStamp = "846ebd3a-dbf2-42f9-b776-006f4b183025",
                            Name = "Student",
            ...
            modelBuilder.Entity("DormAPI.Models.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "bbc68ad5-d335-4f20-9872-2d5e7cbb56e6",
            ...
            modelBuilder.Entity("DormAPI.Models.Entities.Problem", b =>
                {
                    ...
                    b.HasOne("DormAPI.Models.Entities.Item", "Item")
                        .WithMany("Problems")
